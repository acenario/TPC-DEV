...
// Scringo's Tabs
#define kScringoTabActivity             @"feed"
#define kScringoTabMessages             @"inbox"
#define kScringoTabChatRoom             @"blog"
#define kScringoTabFeedback             @"feedback"
#define kScringoTabAppDeals             @"apps"
#define kScringoTabFindInviteFriends    @"invite"
#define kScringoTabRadar                @"radar"
...
+(int)getTabBadgeNumber:(NSString *)tabName;
