...
- (PFQuery *)queryForTable {
    PFQuery *query = [PFQuery queryWithClassName:@"Month"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath object:(PFObject *)object {
    ...
    cell.detailTextLabel.text = [NSString stringWithFormat:@"%@ %@", [object objectForKey:@"time"],[object objectForKey:@"event"]];
