...
- (void)viewDidAppear:(BOOL)animated {
    ...
    if (![PFUser currentUser]) {
        ...
        GovsLoginViewController *logInViewController = [[GovsLoginViewController alloc] init];
        ...
        GovSignUpViewController *signUpViewController = [[GovSignUpViewController alloc] init];
